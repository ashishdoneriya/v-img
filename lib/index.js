...
const addPluginAttributes = (el, binding, options) => {
  ...
  sourceButtonDownloadLink = options.sourceButtonDownloadLink;
  ...
  if (typeof binding.value !== 'undefined') {
    ...
    sourceButtonDownloadLink = binding.value.sourceButtonDownloadLink || sourceButtonDownloadLink;
    // Lifecycle functions
    ...
    if (binding.value.sourceButtonDownloadLink !== undefined) {
      sourceButton = binding.value.sourceButtonDownloadLink;
    }
    // same as above
  ...
  if (sourceButtonDownloadLink) el.setAttribute('data-vue-img-source-button-download-link', sourceButtonDownloadLink);
...
const install = (Vue, options) => {
  ...
  const defaultOptions = {
    altAsTitle: false,
    sourceButton: false,
    sourceButtonDownloadLink: undefined,
    thumbnails: false,
    openOn: 'click',
  };
  ...
  Vue.directive('img', {
    ...
    bind(el, binding) {
      ...
      el.addEventListener(addedAttributes.openOn, () => {
        ...
        Vue.set(vm, 'sourceButtonsDownloadLink', images.map(e => e.dataset.vueImgSourceButtonDownloadLink));
